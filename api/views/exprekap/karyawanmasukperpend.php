...
if (!isset($_GET['print'])) {
    ...
    header("Content-Disposition: attachment; filename=excel-karyawan-masuk-perpendidikan.xls");
}
...
<table width="100%" border="1" style="border-collapse: collapse">
    <thead>
        <tr>
            <td rowspan="2"colspan="4"><center><h4>DATA KARYAWAN MASUK PER PENDIDIKAN</h4><br/></center></td>
<td rowspan="2"colspan="4" >PERIODE : <?= date('d F Y', strtotime($start)) . ' S/D ' . date('d F Y', strtotime($end)); ?></td>
<td align="center">Dibuat</td>
<td align="center" colspan="2">Diketahui</td>
</tr>
<tr>
