...
if (!isset($_GET['print'])) {
    ...
    header("Content-Disposition: attachment; filename=excel-monitoring-asuransi.xls");
}
...
<center><h4>LAPORAN MONITORING ANSURANSI KENDARAAN</h4><br/></center>
...
<table width="100%" border="1" style="border-collapse: collapse">
    <thead>
        <tr>
            ...
            <th style="text-align: center;vertical-align: center;">NAMA ANSURANSI</th>
    ...
    <tbody>
        ...
        foreach ($models as $val) {
            ...
            echo '<td align="center">' . $val['masa_berlaku_sampai'] . '</td>';
            echo '<td align="center">' . $val['nm_ansuransi'] . '</td>';
