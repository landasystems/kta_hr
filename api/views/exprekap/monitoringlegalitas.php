...
<center><h4>LAPORAN JADWAL PENILAIAN</h4><br/></center>
...
<table width="100%" border="1" style="border-collapse: collapse">
    <thead>
        <tr>
            ...
            <th style="text-align: center;vertical-align: center;">PENILAI</th>
            <th style="text-align: center;vertical-align: center;">DEPT. PENILAI</th>
            <th style="text-align: center;vertical-align: center;">YANG DINILAI</th>
            <th style="text-align: center;vertical-align: center;">DEPT.DINILAI</th>
        </tr>
    </thead>
    <tbody>
        <?php
        ...
        foreach ($models as $val) {
            ...
            echo '<td align="center">' . $val['tgl_penilaian'] . '</td>';
            echo '<td align="center">' . $val['penilai'] . '</td>';
            echo '<td align="center">' . $val['dep_penilai'] . '</td>';
