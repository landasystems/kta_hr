     ...
     public function actionExcel() {
       ...
       if (isset($_GET['print'])) {
         return $this->render("/expmaster/kalender", ['models'=>$models]);
            ...
            $path = \Yii::$app->params['path'] . 'api/templates/master-kalender.xls';
...
//
            ...
            foreach ($models as $r => $arr) {
                $no = (!empty($arr['no'])) ? $arr['no'] : '';
                $tgl = (!empty($arr['tgl'])) ? date('d-M-Y',  strtotime($arr['tgl'])) : '';
                $ket = (!empty($arr['ket'])) ? $arr['ket'] : '';
                if (isset($row))
                    $row++;
                else
                    $row = $baseRow + $r;
//
                ...
                $objPHPExcel->getActiveSheet()->mergeCells('C' . $row . ':F' . $row)->setCellValue('B' . $row, $ket);
//
            }
//
