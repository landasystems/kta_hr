...
class JhseController extends Controller {
...
//        $model->tgl = date('Y-m-d',strtotime($model->tgl));
    ...
    protected function findModel($id) {
        if (($model = TblJadwalHse::findOne($id)) !== null) {
            return $model;
        } else {
