app.controller('pemakianLatCtrl', function ($scope, Data, toaster) {
    ...
    $scope.print = function (form) {
        if ('tanggal' in form && form.tanggal.startDate != null) {
            Data.post('pemakaianlat/rekap', form).then(function (data) {
                window.open('api/web/pemakaianlat/excel?print=true', "", "width=500");
            });
        } else {
...
//        if ($query.length >= 3) {
//            Data.get('pemakaianlat/cari', {pemakaianlat: $query}).then(function (data) {
//                $scope.resultspemakaianlat = data.data;
//            });
//        }
//    };
