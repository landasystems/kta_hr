app.controller('magangCtrl', function ($scope, Data, toaster, FileUploader) {
...
//        $scope.form.qty = qty;
//    };
//    Data.get('magang/jenis').then(function(data) {
...
//    });
    $scope.callServer = function callServer(tableState) {
        ...
        paramRef = param;
        Data.get('magang', param).then(function (data) {
    ...
    $scope.save = function (form) {
        ...
        var url = ($scope.is_create == true) ? 'magang/create/' : 'magang/update/' + form.no_magang;
