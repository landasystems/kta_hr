app.controller('siswaPrakerinCtrl', function ($scope, Data, toaster) {
    var tableStateRef;
    var paramRef;
    $scope.form = {};
    ...
    $scope.print = function (form) {
        if ('tanggal' in form && form.tanggal.startDate != null) {
            Data.post('prakerin/rekap', form).then(function (data) {
                window.open('api/web/prakerin/excel?print=true', "", "width=500");
            });
        } else {
...
//        if ($query.length >= 3) {
//            Data.get('prakerin/cari', {prakerin: $query}).then(function (data) {
//                $scope.resultsprakerin = data.data;
//            });
//        }
//    };
